 ...
 */
    public function AffichageHistorique(){
        $query=$this->db->prepare('SELECT ID_Aff,E.Nom AS EmployeeName,E.Prenom,Affectations.ID_Empl, P.Nom AS ProductName, P.Id_Produit ,Affectations.Date_Aff,Affectations.Date_Retraite
        FROM Affectations
